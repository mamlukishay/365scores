...
// PURE — no IO, no Node APIs. Safe to import in both Node (build.mjs) and the
// browser (live on-demand refresh). The snapshot shape it consumes is produced
// by scores-api.mjs `fetchGroupSnapshot()`.
